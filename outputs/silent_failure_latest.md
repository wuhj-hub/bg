...
- quant_report.yml :: 反转数值周线信号上传推送 (L509) — 命中 continue-on-error: true, || true
- quant_report.yml :: 体系自检 — 健康评分 / 市场状态 / 异常检测 (L547) — 命中 continue-on-error: true, set +e, || true
- quant_report.yml :: 推送自检报告到微信 (L565) — 命中 continue-on-error: true
