...
- quant_report.yml :: 纸面组合跟踪（选股方法对比） (L469) — 命中 continue-on-error: true, set +e, || true
- quant_report.yml :: 反转数值周线信号上传推送 (L510) — 命中 continue-on-error: true, || true
- quant_report.yml :: 体系自检 — 健康评分 / 市场状态 / 异常检测 (L548) — 命中 continue-on-error: true, set +e, || true
- quant_report.yml :: 推送自检报告到微信 (L566) — 命中 continue-on-error: true
